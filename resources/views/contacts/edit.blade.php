...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0"><i class="bi bi-person-lines-fill me-2"></i>Edit Contact</h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('contact') is-invalid @enderror" id="phone_number" placeholder="712345678" pattern="[0-9]{9,12}" value="{{ old('contact', $contact->contact) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('department') is-invalid @enderror" id="department" name="department" value="{{ old('department', $contact->department) }}">
                        @error('department')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check2 me-1"></i> Update Contact</button>
